...
var home = (function () {
    ...
    function _render(tab) {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("<p>")
            .text(tab)
            .css({ "color": "black"} )
            .addClass("header")
            .appendTo(main)
...
var taskListView = (function (taskList) {
    ...
    function _renderItem(task) {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("<p>").text(task.title).addClass("item-title").appendTo(container);
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("<div>")
            .attr("data-priority", task.priority)
            .addClass("item-prio")
            .css({ "background-color": priorityColor[task.priority] })
            .appendTo(container);
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("<p>").text(task.date).addClass("item-date").appendTo(container);
    ...
    function _changeTaskStatus(e) {
        const title = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.currentTarget).parent().find("p");
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("img[src$='.svg']").each(function () {
